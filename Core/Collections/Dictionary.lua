...
if Addon.safeProvide then
    Addon.safeProvide("Dictionary", Dictionary, { lifetime = "SingleInstance" })
    Addon.safeProvide("Collections.Dictionary", Dictionary, { lifetime = "SingleInstance" })
elseif Addon.provide then
    if not (Addon.IsProvided and Addon.IsProvided("Dictionary")) then Addon.provide("Dictionary", Dictionary, { lifetime = "SingleInstance" }) end
    if not (Addon.IsProvided and Addon.IsProvided("Collections.Dictionary")) then Addon.provide("Collections.Dictionary", Dictionary, { lifetime = "SingleInstance" }) end
end
