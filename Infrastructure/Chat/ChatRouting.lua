-- Infrastructure/Chat/ChatRouting.lua
-- Minimal chat routing adapter (Retail/Classic safe) for embedded chat features.
...
if Addon.provide and not (Addon.IsProvided and Addon.IsProvided('ChatRouting')) then
  Addon.provide('ChatRouting', function() return CreateChatRouting() end, { lifetime = 'SingleInstance', meta = { area = 'chat', role = 'transport' } })
end
